...
from apps.songwriter.services.permissions import SongPermissionService, Permission
from apps.songwriter.services.yjs_provider import yjs_provider
from apps.songwriter.services.yjs_store import YjsDocumentStore
...
async def _validate_token_and_get_user(token: str, session):
    ...
    """
    from packages.core.auth.users import get_jwt_strategy, get_user_manager
