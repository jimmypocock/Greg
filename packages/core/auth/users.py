...
if TYPE_CHECKING:
    from packages.core.auth.schemas import UserCreate
...
from packages.core.database import Invite, User, UserRole, get_session_dependency

# Constants

from packages.core.config import Config
from packages.core.config.validation import get_required
...
class UserManager(UUIDIDMixin, BaseUserManager[User, uuid.UUID]):
    ...
    async def login(
        ...
        """
        from packages.core.auth.refresh_tokens import create_refresh_token
    ...
    async def refresh_tokens(
        ...
        Raises:
            ...
            UserDisabledError: If user account is disabled
        """
        from packages.core.auth.refresh_tokens import rotate_refresh_token, validate_refresh_token
