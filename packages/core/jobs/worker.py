...
from packages.core.jobs.queue import get_redis_settings
from packages.core.jobs.manager import job_manager
...
async def process_document_arq(
    ...
    """
    from packages.core.jobs.document_worker import process_document_job
...
async def process_url_arq(
    ...
    """
    from packages.core.jobs.document_worker import process_url_job
