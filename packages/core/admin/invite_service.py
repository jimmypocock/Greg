...
from packages.core.auth import generate_invite_code
from packages.core.database import Invite

if TYPE_CHECKING:
    from packages.core.admin.schemas import InviteCreateRequest
