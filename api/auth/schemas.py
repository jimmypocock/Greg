...
class TokenResponse(BaseModel):
    ...
    If requires_2fa is True, access_token and refresh_token will be empty,
    and temp_token will contain a short-lived token to use with /auth/2fa/verify.
    """
...
class DeactivateAccountRequest(BaseModel):
    """Request to deactivate (soft delete) account."""
